...
echo "🎯 Final rebuild with updated CORS for new Railway URL..."
...
echo "✅ CORS updated for newbatikfastapi-production.up.railway.app"
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers with updated CORS..."
...
echo "✅ Final CORS rebuild complete!"
echo "🎯 Your API should now work with frontend at front-end-batik-vision.vercel.app"
echo "🔧 To view logs:"
if [ -f "letsencrypt/live/batik-fast-api.sgp.dom.my.id/fullchain.pem" ]; then
