...
echo "🔧 Simple rebuild with minimal dependencies..."
...
echo "✅ Using minimal dependencies to avoid conflicts"
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers with minimal dependencies..."
