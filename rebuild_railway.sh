...
echo "🚂 Rebuilding for Railway deployment with CORS fix..."
...
echo "✅ CORS configured for front-end-batik-vision.vercel.app"
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers for Railway..."
...
echo "✅ Railway rebuild complete with CORS fix!"
echo "🎯 Your API should now work with the frontend at front-end-batik-vision.vercel.app"
echo "🔧 To view logs:"
if [ -f "letsencrypt/live/batik-fast-api.sgp.dom.my.id/fullchain.pem" ]; then
