...
echo "🔧 Rebuilding with TensorFlow 2.15.0 for model compatibility..."
...
echo "✅ Using TensorFlow 2.15.0 for model compatibility"
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers with TensorFlow 2.15.0..."
...
echo "✅ TensorFlow 2.15.0 rebuild complete!"
