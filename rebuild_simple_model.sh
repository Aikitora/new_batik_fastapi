...
echo "🔧 Rebuilding with simplified model loading approach..."
...
echo "✅ Using simplified model loading approach"
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers with simplified model loading..."
...
echo "✅ Simplified model loading rebuild complete!"
echo "🎯 Your API should now work with the custom dense layer handling"
echo "🔧 To view logs:"
if [ -f "letsencrypt/live/batik-fast-api.sgp.dom.my.id/fullchain.pem" ]; then
