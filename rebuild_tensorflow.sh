...
echo "🔧 Rebuilding with TensorFlow compatibility fix..."
...
# Rebuild and start
echo "🚀 Rebuilding and starting containers with TensorFlow 2.13.0..."
...
echo "✅ Rebuild complete with TensorFlow compatibility!"
echo "🔧 To view logs:"
if [ -f "letsencrypt/live/batik-fast-api.sgp.dom.my.id/fullchain.pem" ]; then
